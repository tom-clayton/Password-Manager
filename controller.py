...
from database import Database, PasswordError
from ui import MainUI, MasterEntryDialog, HandleCreatorDialog, \
...
# file that contains database location:
FILENAME_FILENAME = os.path.join(os.path.dirname(
...
class MainController(object):
    """Program controller"""
    def __init__(self):
        self.db = Database(self.get_filename())
        self.tk_root = Tk()
    ...
    def get_filename(self):
        with open(FILENAME_FILENAME) as fo:
